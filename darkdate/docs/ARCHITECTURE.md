...
| Язык | Код | Регион | Файл |
|------|-----|--------|------|
| Русский | `ru` | Россия | `ru.json` |
| Английский | `en` | Международный | `en.json` |
| Португальский | `pt-BR` | Бразилия | `pt-BR.json` |
| Китайский | `zh-CN` | Упрощённый | `zh-CN.json` |
| Испанский | `es` | Латинская Америка / Европа | `es.json` |
| Японский | `ja` | Япония | `ja.json` |
| Немецкий | `de` | Германия | `de.json` |
| Индонезийский | `id` | Индонезия | `id.json` |
